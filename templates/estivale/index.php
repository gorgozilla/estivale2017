...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
	...
	<?php if($pageId==101 || $pageId==140 || $pageId==142
			...
			|| $pageId==176 || $pageId==177 || $pageId==178 || $pageId==179 || $pageId==186 || $pageId==190 || $pageId==192 || $pageId==194 || $pageId==196 || $pageId==198 || $pageId==200 || $pageId==202 || $pageId==204 || $pageId==206 || $pageId==208 || $pageId==210 || $pageId==212 || $pageId==214 || $pageId==216 || $pageId==222 || $pageId==124 || $pageId==131 || $pageId==161 || $pageId==162 || $pageId==163 || $pageId==181 || $pageId==183 || $pageId==233 || $pageId==175 || $pageId==235
			|| $pageId==153 || $pageId==153 || $pageId==164 || $pageId==165 || $pageId==170 || $pageId==181|| $pageId==184 || $pageId==176 || $pageId==177 || $pageId==178 || $pageId==179 || $pageId==180 || $pageId==188|| $pageId==191|| $pageId==193 || $pageId==195 || $pageId==197 || $pageId==199 || $pageId==201 || $pageId==203|| $pageId==205|| $pageId==207 || $pageId==209 || $pageId==211 || $pageId==213 || $pageId==215 || $pageId==217 || $pageId==223 || $pageId==225 || $pageId==227  || $pageId==180 || $pageId==236 || $pageId==163  || $pageId==164
				...
				<?php if($pageId==101 || $pageId==140 || $pageId==142){ ?>
					<div class="teaser-lineup col-xs-12">
						...
						<?php if($lang=='fr-FR'){ ?>
							...
							<h4>
								<a href="index.php/fr/amir">AMIR</a><span class="white-span">/</span><a href="index.php/fr/olivia-ruiz">OLIVIA RUIZ</a><span class="white-span">/</span><a href="index.php/fr/bastian-baker">BASTIAN BAKER</a><span class="white-span">/</span><a href="index.php/fr/boostee">BOOSTEE</a><span class="white-span">/</span><a href="index.php/fr/prog/lundi-31-juillet/damso">DAMSO</a><span class="white-span">/</span><a href="index.php/fr/maitre-gims">MAITRE GIMS</a>
							</h4>
							<h5>
							...
							<h6>
								<a href="index.php/fr/prog/samedi-29-juillet/pihpoh">PIH POH</a><span class="white-span">/</span><a href="index.php/fr/prog/dimanche-30-juillet/jack-savoretti">JACK SAVORETTI</a><span class="white-span">/</span><a href="index.php/fr/prog/samedi-29-juillet/john-dear">JOHN DEAR</a><span class="white-span">/</span><a href="index.php/fr/prog/mardi-01-aout/get-in-the-car-simone">GET IN THE CAR SIMONE</a><span class="white-span">/</span><a href="index.php/fr/prog/mardi-01-aout/fensta">FENSTA</a><span class="white-span">/</span><a href="index.php/fr/prog/lundi-31-juillet/wintershome">WINTERSHOME</a>
							</h6>
						<?php }else{ ?>
							<h2>
							...
							<h4>
								<a href="index.php/de/amir-allemand">AMIR</a><span class="white-span">/</span><a href="index.php/de/olivia-ruiz-allemand">OLIVIA RUIZ</a><span class="white-span">/</span><a href="index.php/de/bastian-baker-allemand">BASTIAN BAKER</a><span class="white-span">/</span><a href="index.php/de/boostee-allemand">BOOSTEE</a><span class="white-span">/</span><a href="index.php/de/programm/intervalle-montag-31-juli/damso">DAMSO</a><span class="white-span">/</span><a href="index.php/de/maitre-gims-allemand">MAITRE GIMS</a>
							</h4>
							<h5>
							...
							<h6>
								<a href="index.php/de/programm/samstag-29-juli/pihpoh">PIH POH</a><span class="white-span">/</span><a href="index.php/de/programm/sonntag-30-juli/jack-savoretti">JACK SAVORETTI</a><span class="white-span">/</span><a href="index.php/de/programm/samstag-29-juli/john-dear">JOHN DEAR</a><span class="white-span">/</span><a href="index.php/de/programm/dienstag-01-august/get-in-the-car-simone">GET IN THE CAR SIMONE</a><span class="white-span">/</span><a href="index.php/fr/prog/mardi-01-aout/fensta">FENSTA</a><span class="white-span">/</span><a href="index.php/de/programm/intervalle-montag-31-juli/wintershome">WINTERSHOME</a>
							</h6>						
						<?php } ?>
					</div>
