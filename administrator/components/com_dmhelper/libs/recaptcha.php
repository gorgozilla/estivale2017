<?php
	...
	**/
	...
	class DMReCaptcha {
		...
		public static function recaptcha_check_answer($privkey, $remoteip, $challenge, $response, $extra_params = array()) {
			...
			if ($challenge == null || strlen($challenge) == 0 || $response == null || strlen($response) == 0) {
				$recaptcha_response = new DMReCaptchaResponse();
	...
	/**
	 * A DMReCaptchaResponse is returned from recaptcha_check_answer()
	 */
	class DMReCaptchaResponse {
		var $is_valid;
		var $error;
	}
