...
class EstipressHelpersView
{
	function load($viewName, $layoutName='default', $viewFormat='html', $vars=null)
	{
	    ...
	    $viewClass  = 'EstipressView' . ucfirst($viewName) . ucfirst($viewFormat);
	    $modelClass = 'EstipressModelMember';
	...
	{
		$objectView = EstipressHelpersView::load($view, $layout, 'phtml');
