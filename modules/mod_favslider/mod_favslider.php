...
// Google Font
JHTML::stylesheet('//fonts.googleapis.com/css?family='.str_replace(" ","+",$captionTitleGoogleFont));
JHTML::stylesheet('//fonts.googleapis.com/css?family='.str_replace(" ","+",$captionDescriptionGoogleFont));
JHTML::stylesheet('//fonts.googleapis.com/css?family='.str_replace(" ","+",$captionReadMoreGoogleFont));
...
<script type="text/javascript">
  ...
  <?php if ($layoutEffect != 'layout-effect-none') { ?>

    jQuery(document).ready(function() {

      jQuery('#slider-<?php echo $rand; ?> .layout-effect').addClass("favhide").viewportCheckerfavslider({
